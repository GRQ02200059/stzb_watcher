...
data class ReferencedDetailExecutionOverride(
    ...
    val targetOverride: List<com.stzb.battle.core.BattleHeroRef>? = null,
...
data class EffectInvocation(
    ...
    val preselectedTargets: List<com.stzb.battle.core.BattleHeroRef>? = null,
...
class BattleEffectRegistry private constructor(
    ...
    fun execute(
        ...
        preselectedTargets: List<com.stzb.battle.core.BattleHeroRef>? = null,
...
): List<com.stzb.battle.core.BattleHeroRef> =
